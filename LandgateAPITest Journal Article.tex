...
\runningtitle{Landgate API Test}
...
\author{Aiden Price}\affil{Spatial Sciences, Curtin University, Australia}

\maketitle

% Add 5-10 keywords for every submission
\keywords{spatial web services, OGC, WMS, WMTS, WFS, mobile, testing, Google Maps Engine, Esri ReST}
